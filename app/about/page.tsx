...
export const metadata = {
  ...
  description:
    "Learn about our mission, vision, and holistic approach to wellness",
};
        ...
        <div className="container">
          ...
          <div className="max-w-[900px] mx-auto mb-16 text-center">
            ...
            <p className="text-lg leading-relaxed mb-6">
              Life Beyond Medicine is dedicated to helping individuals discover
              the path to complete wellness through holistic healing practices.
              We believe that true health encompasses not just the absence of
              disease, but a state of complete physical, mental, and spiritual
              well-being.
            </p>
            <p className="text-lg leading-relaxed">
              Our approach integrates ancient wisdom with modern understanding,
              offering a comprehensive range of natural healing modalities that
              address the root causes of imbalance rather than merely treating
              symptoms.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16 p-12 bg-[#e8f0dc] rounded-lg">
            ...
            <div>
              <h2 className="text-[2.5rem] text-[#003366] mb-6">
                Sjt. Surekha S. Punamiya
              </h2>
              ...
              <div className="space-y-3 mb-6">
                <div>
                  ...
                  <span className="ml-2 text-[#666666]">
                    Naturopath, Yoga Therapist, Nutritionist, CPA Counselor
                  </span>
                </div>
                <div>
                  ...
                  <span className="ml-2 text-[#666666]">
                    Sujok Smile Healer & Smile Meditation
                  </span>
                </div>
                <div>
                  <span className="font-bold text-[#003366]">Role:</span>
                  <span className="ml-2 text-[#666666]">
                    Chairperson – JITO Goregaon Ladies Wing
                  </span>
                </div>
                <div>
                  <span className="font-bold text-[#003366]">Project:</span>
                  <span className="ml-2 text-[#666666]">
                    Sparsh Ek Ehsaas (District 314)
                  </span>
                </div>
                <div>
                  <span className="font-bold text-[#003366]">Email:</span>
                  <a
                    href="mailto:punamiyasurekha@gmail.com"
                    className="ml-2 text-[#7c9d5c] hover:text-[#4a5d3c]"
                  >
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2 text-[#666666]">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
                    <span>
                      Past President – Inner Wheel Club of Borivali (2010–11)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
                    <span>
                      Volunteer – Toybank (Facilitator for Toy Library)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
                    <span>
                      Workshop Facilitator – Anti-Smoking & Anti-Tobacco (CPA)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
                    <span>
                      Chairperson – Sthanakwasi Sadri Women Organisation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
                    <span>
                      Chairperson – SEWA IQ, Rajasthani Ekta Women Organisation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#7c9d5c] mt-1">•</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16 p-12 bg-[#e8f0dc] rounded-lg">
            <div>
              ...
              <p className="text-lg leading-relaxed mb-6">
                We envision a world where holistic wellness is accessible to
                all, where individuals are empowered to take charge of their
                health through natural means, and where the healing wisdom of
                ancient traditions is valued alongside modern medical advances.
              </p>
              <p className="text-lg leading-relaxed">
                Through education, compassionate care, and personalized healing
                protocols, we strive to create a community of individuals who
                live in harmony with nature and experience optimal vitality in
                all aspects of life.
              </p>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  <div className="text-[#c17c4b] mb-4 flex justify-center">
                    {value.icon}
                  </div>
          ...
          <div className="mb-16 p-12 bg-[#f5f1e8] rounded-lg">
            <h2 className="text-[2.5rem] text-center mb-6">
              Our Holistic Approach
            </h2>
            <p className="text-center text-lg max-w-[800px] mx-auto mb-12">
              At Life Beyond Medicine, we understand that health is
              multifaceted. Our integrated approach addresses all dimensions of
              wellness:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={index}
                  className="bg-white p-8 rounded-lg border-l-4 border-[#7c9d5c]"
                >
          ...
          <div className="text-center p-12 bg-gradient-to-br from-[#7c9d5c] to-[#4a5d3c] rounded-lg text-white">
            <h2 className="text-white text-[2.5rem] mb-4">
              Begin Your Wellness Journey Today
            </h2>
            <p className="text-white text-xl mb-8">
              Experience the transformative power of holistic healing
            </p>
